...
pub fn function(lang:Lang) {
    ...
    for n in 77..81 {
        ask_n_check_animal(n, 1, 40, Animal::Cat, lang);
    }
    print_level(5, lang);
    for n in 81..96 {
    ...
    for n in 97..101 {
        ask_n_check_animal(n, 1, 50, Animal::Dog, lang);
    }
    print_level(6, lang);
    for n in 101..116 {
    ...
    for n in 117..121 {
        ask_n_check_animal(n, 1, 60, Animal::Horse, lang);
    }
    print_level(7, lang);
    for n in 121..139 {
    ...
    ask_n_check_num(136, 80, 81, lang);
    for n in 137..141 {
    ...
    for n in 142..150 {
        ask_n_check_num(n, 90, 100, lang);
    }
    ask_n_check_num(150, 100, 101, lang);
    for n in 151..157 {
        ask_n_check_num(n, 100, 200, lang);
    }
    ask_n_check_drink(157, 1, 2, Drink::Coffee, lang);
    for n in 158..161 {
    ...
    ask_n_check_drink(165, 1, 2, Drink::Water, lang);
    for n in 166..176 {
