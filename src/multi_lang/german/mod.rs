...
use crate::german::number::all_num;
use crate::german::animal;
use crate::german::drink;
use crate::german::food;
use crate::german::fruit;
use crate::german::transport;

use crate::german::Thing;
use crate::thisis::ThisIs;
use crate::german::print_what_is_it;
use crate::german::print_correct;
use crate::german::print_correct_ans;
use crate::german::process_ans;
use crate::german::print_level;
use crate::german::print_what_num;
