...
use german::ask_n_check_drink_sub;
use german::ask_n_check_fruit_sub;
use german::ask_n_check_food_sub;
use german::ask_n_check_animal_sub;
use german::ask_n_check_transport_sub;
use german::ask_n_check_num_sub;
use german::print_level_sub;
use crate::german::print_update_at_sub;
use crate::german::print_type_exit_to_exit_sub;
